                    ...
                    <div>
                        <div class="form-group">
                            <section class="range-slider">
                                ...
                                <input name="rangeOne" value="1000" min="0" max="400000" step="1" type="range" name="min">
                                <input name="rangeTwo" value="400000" min="0" max="400000" step="1" type="range" name="max">
                            </section>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function form_post() {
        $(".product_form input").change(function() {
            $.post("product-list-api.php", $(".product_form").serialize(), function(date) {
                // `<div class="prd_cards" style="background-color: #fff;">
                //     <figure class="prd_pic"><img src="./img/product/lens/<?= $r['images'] ?>.png" alt=""></figure>
                //     <h6><?= $r['model'] ?></h6>
                //     <ul>
